  ...
  return (
    <section className="mt-[-72px] bg-primary-50 dark:bg-slate-800" id="heroTwo">
      <div className="mx-auto max-w-7xl px-4 pt-[72px] sm:px-6 md:flex md:h-screen 2xl:h-auto">
        <div className="block py-6 text-center md:flex md:py-6 md:text-left lg:py-8">
          <div className="mx-auto flex max-w-5xl basis-[56%] items-center">
            <div className="max-w-3xl pb-6 pr-0 md:py-0 md:pr-4 md:pb-0 lg:pr-8">
              {tagline && (
              ...
              {title && (
                <h1 className="leading-tighter font-heading mb-4 px-4 text-5xl font-bold tracking-tighter md:px-0 md:text-[2.00rem]">
                  {title}
                </h1>
              )}
          ...
          <div className="block flex-1 items-center md:flex">
            <div className="relative m-auto max-w-4xl aspect-[4/3] w-full h-auto">
              {image && (
                  <Image
